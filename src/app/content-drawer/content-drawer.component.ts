...
export class ContentDrawerComponent {
  ...
  ngAfterViewInit() {
    ...
    this.renderer.setStyle(this.element.nativeElement, 'top', this.platform.height() - this.handleHeight*11 + 'px');
  ...
  handlePan(ev){
    ...
    if((newTop < this.thresholdTop && ev.additionalEvent === "panup") || bounceToTop){
      ...
      this.domCtrl.write(() => {
        ...
        this.renderer.setStyle(this.element.nativeElement, 'top', '54.3px');
      });
